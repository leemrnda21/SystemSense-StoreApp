...
const SETTLEMENT_TABLES: TableData[] = [
  { 
    ...
    items: [
      ...
      { name: 'Pork Grilled Dish Set', qty: 2, price: 295 },
    ]
  },
  { 
    id: 'T-05', 
    ...
    timestamp: '14:30',
    items: [
      { name: 'Red Curry', qty: 2, price: 450 },
      { name: 'Pad Thai', qty: 1, price: 120 },
      { name: 'Spring Rolls', qty: 3, price: 45 },
    ]
  },
  { 
    id: 'T-08', 
    ...
    timestamp: '13:45',
    items: [
      { name: 'Tom Yum Goong', qty: 2, price: 350 },
      { name: 'Massaman Beef', qty: 1, price: 450 },
      { name: 'Green Curry', qty: 2, price: 400 },
    ]
  },
]

interface Props {
  onTableSelect: (tableId: string, amount: number, items?: Array<{ name: string; qty: number; price: number }>) => void
}
